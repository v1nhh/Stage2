...
namespace CloudAPI.Migrations
{
    ...
    [Migration("20240312143138_APISettingModifyColumns")]
    partial class APISettingModifyColumns
    {
            ...
            modelBuilder.Entity("CommunicationModule.ApplicationCore.Entities.MailTemplate", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Template = "عزيزي {{name}}،<br /><br />اضغط على الرابط أدناه لتغيير كلمة المرور الخاصة بك.<br /><br /><a href='{{link}}' target='_blank'>تغيير كلمة المرور</a><br /><br />أنت تتلقى هذا البريد الإلكتروني لأنك ضغطت مؤخرًا على زر 'نسيت كلمة المرور' على موقع CaptureTech. إذا لم تكن قد بدأت هذا التغيير، يرجى الاتصال بالمسؤول الخاص بك فورًا."
                        },
                        new
                        {
                            ID = 38,
            ...
            modelBuilder.Entity("UserRoleModule.ApplicationCore.Entities.CTAMSetting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ID = 12,
                            CTAMModule = 0,
                            CreateDT = new DateTime(2024, 3, 11, 14, 16, 53, 157, DateTimeKind.Utc).AddTicks(456),
                            ParName = "enqueue_requests_interval",
                            ParValue = "15"
                        });
                });
