...
namespace CloudAPI.Migrations
{
    ...
    [Migration("20221221131957_UpdateMailTemplatesBulkMailAmountSetting")]
    partial class UpdateMailTemplatesBulkMailAmountSetting
    {
            ...
            modelBuilder.Entity("CabinetModule.ApplicationCore.Entities.CabinetCellType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Color = "None",
                            CreateDT = new DateTime(2022, 12, 21, 13, 19, 56, 941, DateTimeKind.Utc).AddTicks(5925),
                            Depth = 30.0,
                            Height = 30.0,
                            ...
                            SpecCode = "L30",
                            SpecType = 0,
                            UpdateDT = new DateTime(2022, 12, 21, 13, 19, 56, 941, DateTimeKind.Utc).AddTicks(5928),
                            Width = 30.0
                        },
                        new
                        {
                            ID = 2,
                            Color = "None",
                            CreateDT = new DateTime(2022, 12, 21, 13, 19, 56, 941, DateTimeKind.Utc).AddTicks(5932),
                            Depth = 0.0,
                            Height = 0.0,
                            LockType = "Type of lock",
                            LongDescr = "",
                            ...
                            SpecCode = "I",
                            SpecType = 1,
                            UpdateDT = new DateTime(2022, 12, 21, 13, 19, 56, 941, DateTimeKind.Utc).AddTicks(5932),
                            Width = 0.0
                        },
                        new
                        {
                            ID = 3,
                            Color = "Red",
                            CreateDT = new DateTime(2022, 12, 21, 13, 19, 56, 941, DateTimeKind.Utc).AddTicks(5934),
                            Depth = 30.0,
                            Height = 15.0,
                            LockType = "Type of lock",
                            LongDescr = "",
                            ...
                            SpecCode = "L15",
                            SpecType = 0,
                            UpdateDT = new DateTime(2022, 12, 21, 13, 19, 56, 941, DateTimeKind.Utc).AddTicks(5934),
                            Width = 30.0
                        },
                        new
                        {
                            ID = 4,
                            Color = "Red",
                            CreateDT = new DateTime(2022, 12, 21, 13, 19, 56, 941, DateTimeKind.Utc).AddTicks(5935),
                            Depth = 45.0,
                            Height = 15.0,
                            LockType = "Type of lock",
                            LongDescr = "",
                            ...
                            SpecCode = "L45",
                            SpecType = 0,
                            UpdateDT = new DateTime(2022, 12, 21, 13, 19, 56, 941, DateTimeKind.Utc).AddTicks(5936),
                            Width = 45.0
                        },
                        new
                        {
                            ID = 5,
                            Color = "Red",
                            CreateDT = new DateTime(2022, 12, 21, 13, 19, 56, 941, DateTimeKind.Utc).AddTicks(5937),
                            Depth = 45.0,
                            Height = 15.0,
                            LockType = "Type of lock",
                            LongDescr = "",
                            ...
                            SpecCode = "L20",
                            SpecType = 0,
                            UpdateDT = new DateTime(2022, 12, 21, 13, 19, 56, 941, DateTimeKind.Utc).AddTicks(5937),
                            Width = 20.0
                        });
                });
            ...
            modelBuilder.Entity("CommunicationModule.ApplicationCore.Entities.MailMarkupTemplate", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreateDT = new DateTime(2022, 12, 21, 13, 19, 56, 969, DateTimeKind.Utc).AddTicks(708),
                            Name = "default_ct",
            ...
            modelBuilder.Entity("CommunicationModule.ApplicationCore.Entities.MailTemplate", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Template = "Beste IBK beheerder, <br/><br/>Item '{{itemDescription}}' van type '{{itemTypeDescription}}' is defect gemeld door gebruiker '{{userName}}' met errorcode:  '{{errorCodeDescription}}'. <br/><br/>U kunt het ophalen aan de IBK '{{cabinetName}}' op positie '{{positionAlias}}'."
                        },
                        new
                        {
                            ID = 20,
                        ...
                        new
                        {
                            ...
                            Subject = "Pas registreren bij een IBK",
                            Template = "\r\nBeste collega,<br/><br/>\r\n\r\nVoorheen moest je voor een portofoon-reparatie een afspraak maken bij een LO-servicebalie. Verdeeld over Eenheid Den Haag zijn nu echter onbemande Intelligente BeheerKasten (IBK’s) geplaatst waar je direct en 24x7 terecht kunt om een defecte portofoon om te ruilen voor een werkend tijdelijk exemplaar. <br/>\r\nAls jouw portofoon gerepareerd is, krijg je hiervan een melding en kun je de tijdelijke portofoon bij dezelfde IBK weer omruilen voor jouw eigen portofoon.<br/><br/>\r\n\r\nOm jezelf als IBK-gebruiker te registeren moet jouw pas eenmalig gekoppeld worden aan het IBK-systeem. Dit kun je vandaag al doen zodat je later, in geval van een portofoon-defect direct geholpen kunt worden.<br/>\r\n1.	Ga naar een IBK (klik <a href='https://www.politie.nl/mijn-buurt/politiebureaus'>hier</a> voor een lijst met IBK-locaties binnen jouw Eenheid).<br/>\r\n2.	Druk op de knop ‘Nieuwe pas koppelen’ op het IBK-scherm.<br/>\r\n3.	Voer in het veld ‘Vul usercode in’ jouw Youforcenummer <i>‘{{loginCode}}’</i> in.<br/>\r\n4.	Voer in het veld ‘Vul pincode in’ deze pincode <i>‘{{pinCode}}’</i> in.<br/>\r\n5.	Scan jouw politie-toegangspas bij de kaartlezer onder het scherm (dit is dezelfde pas die toegang geeft tot de politiepanden/locaties).<br/>\r\nHet groene scherm met ‘pas koppelen geslaagd’ geeft vervolgens aan dat alles goed gegaan is en dat je vanaf nu met een defecte portofoon altijd snel geholpen kunt worden bij een willekeurige IBK van jouw Eenheid.<br/><br/>\r\n\r\nZie voor meer uitleg, <a href='https://www.politie.nl/onderwerpen'>hulp en FAQ</a>.<br/><br/>\r\n\r\n<b>Beantwoord deze e-mail niet, deze is verzonden via een ‘no-reply-adres’.</b><br/>\r\n"
                        },
                        new
                        {
                            ID = 30,
                        ...
                        new
                        {
                            ...
                            Template = "Beste {{name}},<br/><br/>Uw nieuwe pincode is {{pinCode}}<br/>"
                        },
                        new
                        {
                            ID = 32,
                            ...
                            Name = "pincode_changed",
                            Subject = "Reset pincode",
                            Template = "Dear {{name}},<br/><br/>Your new pincode is {{pinCode}}<br/>Change it as soon as you login!"
                        });
                });
            ...
            modelBuilder.Entity("UserRoleModule.ApplicationCore.Entities.CTAMPermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            CTAMModule = 1,
                            CreateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4068),
                            Description = "Swap",
                            UpdateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4072)
                        },
                        new
                        {
                            ID = 3,
                            CTAMModule = 1,
                            CreateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4074),
                            Description = "Return",
                            UpdateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4075)
                        },
                        new
                        {
                            ID = 4,
                            CTAMModule = 1,
                            CreateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4075),
                            Description = "Pickup",
                            UpdateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4076)
                        },
                        new
                        {
                            ID = 5,
                            CTAMModule = 1,
                            CreateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4076),
                            Description = "Borrow",
                            UpdateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4077)
                        },
                        new
                        {
                            ID = 6,
                            CTAMModule = 1,
                            CreateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4078),
                            Description = "Repair",
                            UpdateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4078)
                        },
                        new
                        {
                            ID = 7,
                            CTAMModule = 1,
                            CreateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4079),
                            Description = "Replace",
                            UpdateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4079)
                        },
                        new
                        {
                            ID = 8,
                            CTAMModule = 1,
                            CreateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4081),
                            Description = "Remove",
                            UpdateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4082)
                        },
                        new
                        {
                            ID = 9,
                            CTAMModule = 1,
                            CreateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4082),
                            Description = "Add",
                            UpdateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4083)
                        },
                        new
                        {
                            ID = 10,
                            CTAMModule = 0,
                            CreateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4083),
                            Description = "Read",
                            UpdateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4084)
                        },
                        new
                        {
                            ID = 11,
                            CTAMModule = 0,
                            CreateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4087),
                            Description = "Write",
                            UpdateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4087)
                        },
                        new
                        {
                            ID = 12,
                            CTAMModule = 0,
                            CreateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4088),
                            Description = "Delete",
                            UpdateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4089)
                        },
                        new
                        {
                            ID = 13,
                            CTAMModule = 1,
                            CreateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4089),
                            Description = "Admin",
                            UpdateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4090)
                        });
                });
            ...
            modelBuilder.Entity("UserRoleModule.ApplicationCore.Entities.CTAMSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 3,
                            CTAMModule = 0,
                            CreateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4222),
                            ParName = "email_default_language",
                            ParValue = "nl-NL",
                            UpdateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4223)
                        },
                        new
                        {
                            ID = 4,
                            CTAMModule = 1,
                            CreateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4224),
                            ParName = "hwapi_timeout",
                            ParValue = "30",
                            UpdateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4224)
                        },
                        new
                        {
                            ID = 5,
                            CTAMModule = 0,
                            CreateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4226),
                            ParName = "should_send_cabinet_login",
                            ParValue = "false",
                            UpdateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4226)
                        },
                        new
                        {
                            ID = 6,
                            CTAMModule = 1,
                            CreateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4227),
                            ParName = "show_language_selection_on_cabinet",
                            ParValue = "false",
                            UpdateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4227)
                        },
                        new
                        {
                            ID = 7,
                            CTAMModule = 0,
                            CreateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4228),
                            ParName = "bulk_mail_amount",
                            ParValue = "5",
                            UpdateDT = new DateTime(2022, 12, 21, 13, 19, 56, 919, DateTimeKind.Utc).AddTicks(4229)
                        });
                });
