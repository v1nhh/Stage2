...
namespace CloudAPI.Migrations
{
    ...
    [Migration("20230119130622_MailTemplateDefectUpdated")]
    partial class MailTemplateDefectUpdated
    {
            ...
            modelBuilder.Entity("CabinetModule.ApplicationCore.Entities.CabinetCellType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Color = "None",
                            CreateDT = new DateTime(2023, 1, 19, 13, 6, 21, 498, DateTimeKind.Utc).AddTicks(3407),
                            Depth = 30.0,
                            Height = 30.0,
                            ...
                            SpecCode = "L30",
                            SpecType = 0,
                            UpdateDT = new DateTime(2023, 1, 19, 13, 6, 21, 498, DateTimeKind.Utc).AddTicks(3412),
                            Width = 30.0
                        },
                        new
                        {
                            ID = 2,
                            Color = "None",
                            CreateDT = new DateTime(2023, 1, 19, 13, 6, 21, 498, DateTimeKind.Utc).AddTicks(3417),
                            Depth = 0.0,
                            Height = 0.0,
                            LockType = "Type of lock",
                            LongDescr = "",
                            ...
                            SpecCode = "I",
                            SpecType = 1,
                            UpdateDT = new DateTime(2023, 1, 19, 13, 6, 21, 498, DateTimeKind.Utc).AddTicks(3418),
                            Width = 0.0
                        },
                        new
                        {
                            ID = 3,
                            Color = "Red",
                            CreateDT = new DateTime(2023, 1, 19, 13, 6, 21, 498, DateTimeKind.Utc).AddTicks(3419),
                            Depth = 30.0,
                            Height = 15.0,
                            LockType = "Type of lock",
                            LongDescr = "",
                            ...
                            SpecCode = "L15",
                            SpecType = 0,
                            UpdateDT = new DateTime(2023, 1, 19, 13, 6, 21, 498, DateTimeKind.Utc).AddTicks(3420),
                            Width = 30.0
                        },
                        new
                        {
                            ID = 4,
                            Color = "Red",
                            CreateDT = new DateTime(2023, 1, 19, 13, 6, 21, 498, DateTimeKind.Utc).AddTicks(3421),
                            Depth = 45.0,
                            Height = 15.0,
                            LockType = "Type of lock",
                            LongDescr = "",
                            ...
                            SpecCode = "L45",
                            SpecType = 0,
                            UpdateDT = new DateTime(2023, 1, 19, 13, 6, 21, 498, DateTimeKind.Utc).AddTicks(3422),
                            Width = 45.0
                        },
                        new
                        {
                            ID = 5,
                            Color = "Red",
                            CreateDT = new DateTime(2023, 1, 19, 13, 6, 21, 498, DateTimeKind.Utc).AddTicks(3423),
                            Depth = 45.0,
                            Height = 15.0,
                            LockType = "Type of lock",
                            LongDescr = "",
                            ...
                            SpecCode = "L20",
                            SpecType = 0,
                            UpdateDT = new DateTime(2023, 1, 19, 13, 6, 21, 498, DateTimeKind.Utc).AddTicks(3427),
                            Width = 20.0
                        });
                });
            ...
            modelBuilder.Entity("CommunicationModule.ApplicationCore.Entities.MailMarkupTemplate", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreateDT = new DateTime(2023, 1, 19, 13, 6, 21, 517, DateTimeKind.Utc).AddTicks(9767),
                            Name = "default_ct",
            ...
            modelBuilder.Entity("CommunicationModule.ApplicationCore.Entities.MailTemplate", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Template = "Item <i>'{{putItemDescription}}'</i> met CI-nummer <i>'{{putItemExternalReferenceID}}'</i> van het type <i>'{{putItemTypeDescription}}'</i> is op <i>'{{actionDT}}'</i> defect gemeld door gebruiker <i>'{{userName}}'</i> met errorcode: <i>'{{errorCode}}' '{{errorCodeDescription}}'</i>. U kunt het ophalen aan de IBK <i>'{{cabinetName}}'</i> op locatie <i>'{{cabinetLocationDescr}}' '{{cabinetDescription}}'</i>.<br/><br/> Gebruiker <i>'{{userName}}'</i> heeft nu tijdelijk vervangend item <i>'{{takeItemDescription}}'</i> met CI-nummer <i>'{{takeItemExternalReferenceID}}'</i> van het type <i>'{{takeItemTypeDescription}}'</i> in gebruik.<br/><br/><b>Beantwoord deze e-mail niet, deze is verzonden via een 'no-reply-adres.</b>"
                        },
                        new
                        {
                            ID = 22,
            ...
            modelBuilder.Entity("UserRoleModule.ApplicationCore.Entities.CTAMPermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            CTAMModule = 1,
                            CreateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8476),
                            Description = "Swap",
                            UpdateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8478)
                        },
                        new
                        {
                            ID = 3,
                            CTAMModule = 1,
                            CreateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8482),
                            Description = "Return",
                            UpdateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8482)
                        },
                        new
                        {
                            ID = 4,
                            CTAMModule = 1,
                            CreateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8483),
                            Description = "Pickup",
                            UpdateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8483)
                        },
                        new
                        {
                            ID = 5,
                            CTAMModule = 1,
                            CreateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8484),
                            Description = "Borrow",
                            UpdateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8484)
                        },
                        new
                        {
                            ID = 6,
                            ...
                            CreateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8484),
                            Description = "Repair",
                            UpdateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8485)
                        },
                        new
                        {
                            ID = 7,
                            CTAMModule = 1,
                            CreateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8485),
                            Description = "Replace",
                            UpdateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8486)
                        },
                        new
                        {
                            ID = 8,
                            CTAMModule = 1,
                            CreateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8487),
                            Description = "Remove",
                            UpdateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8488)
                        },
                        new
                        {
                            ID = 9,
                            CTAMModule = 1,
                            CreateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8488),
                            Description = "Add",
                            UpdateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8488)
                        },
                        new
                        {
                            ID = 10,
                            CTAMModule = 0,
                            CreateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8489),
                            Description = "Read",
                            UpdateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8489)
                        },
                        new
                        {
                            ID = 11,
                            CTAMModule = 0,
                            CreateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8491),
                            Description = "Write",
                            UpdateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8491)
                        },
                        new
                        {
                            ID = 12,
                            CTAMModule = 0,
                            CreateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8492),
                            Description = "Delete",
                            UpdateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8492)
                        },
                        new
                        {
                            ID = 13,
                            CTAMModule = 1,
                            CreateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8493),
                            Description = "Admin",
                            UpdateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8493)
                        });
                });
            ...
            modelBuilder.Entity("UserRoleModule.ApplicationCore.Entities.CTAMSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 3,
                            CTAMModule = 0,
                            CreateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8603),
                            ParName = "email_default_language",
                            ParValue = "nl-NL",
                            UpdateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8605)
                        },
                        new
                        {
                            ID = 4,
                            CTAMModule = 1,
                            CreateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8606),
                            ParName = "hwapi_timeout",
                            ParValue = "30",
                            UpdateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8606)
                        },
                        new
                        {
                            ID = 5,
                            CTAMModule = 0,
                            CreateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8608),
                            ParName = "should_send_cabinet_login",
                            ParValue = "false",
                            UpdateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8608)
                        },
                        new
                        {
                            ID = 6,
                            CTAMModule = 1,
                            CreateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8609),
                            ParName = "show_language_selection_on_cabinet",
                            ParValue = "false",
                            UpdateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8609)
                        },
                        new
                        {
                            ID = 7,
                            CTAMModule = 0,
                            CreateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8615),
                            ParName = "bulk_mail_amount",
                            ParValue = "5",
                            UpdateDT = new DateTime(2023, 1, 19, 13, 6, 21, 473, DateTimeKind.Utc).AddTicks(8615)
                        });
                });
